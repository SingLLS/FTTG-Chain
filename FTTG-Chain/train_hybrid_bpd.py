...
BPD1 Dataset Adaptation (Orderers = 3, Fixed Topology)

Run:
python train_hybrid_bpd.py \
...
def main():
    ...
    parser.add_argument("--dataset", default="../data/BPD1.csv")
    ...
    # Topology input (fixed-size consensus graph)
    ...
    model = HybridFTTRaftGAT(num_features=3, max_orderers=3)
    ...
    torch.save(
        ...
        "modelB1/Hybrid_FTT_RaftGAT.pth"
    )

    print("✔ Training finished on BPD dataset.")
