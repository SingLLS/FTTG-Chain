# test_vanilla_transformer_std.py
# -*- coding: utf-8 -*-

"""
Stability Test for Vanilla Transformer
...
def load_dataset(csv_path, scaler_X):
    ...
    arrival = df["Actual Transaction Arrival Rate"].values.astype(float)
...
def main():
    ...
    model_paths = {
        "seed_42": "model_baselines/VanillaTransformer_42.pth",
        "seed_2024": "model_baselines/VanillaTransformer_2024.pth",
    }
